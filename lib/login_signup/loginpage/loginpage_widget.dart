                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            if (functions.newCustomFunction(_model
                                                    .emailAddressLoginController
                                                    .text) !=
                                                'Registration successful!') {
                                              ScaffoldMessenger.of(context)
                                                ...
                                                onFieldSubmitted: (_) async {
                                                  ...
                                                  if (functions
                                                    ...
                                                    ScaffoldMessenger.of(
                                                      ...
                                                      SnackBar(
                                                        content: Text(
                                                          'Registration Failed! Please use BU email',
                                                          style: TextStyle(
                                                            color: FlutterFlowTheme
                                                                    .of(context)
                                                                .primaryText,
