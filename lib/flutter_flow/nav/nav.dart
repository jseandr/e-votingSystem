...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? StudentHomeWidget() : LoginpageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'studentSetting',
          path: '/studentSetting',
          builder: (context, params) => StudentSettingWidget(),
        ),
        FFRoute(
          name: 'resetPassword',
          path: '/resetPassword',
        ...
        FFRoute(
          name: 'adminInsert',
          path: '/adminInsert',
          builder: (context, params) => AdminInsertWidget(),
        ),
        FFRoute(
          name: 'studentVoting',
          path: '/studentVoting',
          builder: (context, params) => StudentVotingWidget(),
        ),
        FFRoute(
